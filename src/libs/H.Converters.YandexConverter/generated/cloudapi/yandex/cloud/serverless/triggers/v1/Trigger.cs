    ...
    static TriggerReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "cm90byKWDgoHVHJpZ2dlchIKCgJpZBgBIAEoCRIfCglmb2xkZXJfaWQYAiAB",
            ...
            "ZXkYASABKAkSDQoFdmFsdWUYAiABKAk6AjgBGtMCCgRSdWxlEkMKBXRpbWVy",
            ...
            "LnNlcnZlcmxlc3MudHJpZ2dlcnMudjEuVHJpZ2dlci5Jb1RNZXNzYWdlSAAS",
            "VAoOb2JqZWN0X3N0b3JhZ2UYBSABKAsyOi55YW5kZXguY2xvdWQuc2VydmVy",
            "bGVzcy50cmlnZ2Vycy52MS5UcmlnZ2VyLk9iamVjdFN0b3JhZ2VIAEIMCgRy",
            "dWxlEgTAwTEBGpMBCgVUaW1lchImCg9jcm9uX2V4cHJlc3Npb24YASABKAlC",
            "DejHMQGKyDEFPD0xMDASUgoPaW52b2tlX2Z1bmN0aW9uGGUgASgLMjcueWFu",
            "ZGV4LmNsb3VkLnNlcnZlcmxlc3MudHJpZ2dlcnMudjEuSW52b2tlRnVuY3Rp",
            "b25PbmNlSABCDgoGYWN0aW9uEgTAwTEBGsICCgxNZXNzYWdlUXVldWUSEAoI",
            "cXVldWVfaWQYCyABKAkSKAoSc2VydmljZV9hY2NvdW50X2lkGAMgASgJQgzo",
            "xzEBisgxBDw9NTASUAoOYmF0Y2hfc2V0dGluZ3MYBCABKAsyMi55YW5kZXgu",
            "Y2xvdWQuc2VydmVybGVzcy50cmlnZ2Vycy52MS5CYXRjaFNldHRpbmdzQgTo",
            "xzEBEkAKEnZpc2liaWxpdHlfdGltZW91dBgFIAEoCzIZLmdvb2dsZS5wcm90",
            "b2J1Zi5EdXJhdGlvbkIJ+scxBTw9MTJoElIKD2ludm9rZV9mdW5jdGlvbhhl",
            "IAEoCzI3LnlhbmRleC5jbG91ZC5zZXJ2ZXJsZXNzLnRyaWdnZXJzLnYxLklu",
            "dm9rZUZ1bmN0aW9uT25jZUgAQg4KBmFjdGlvbhIEwMExARq3AQoKSW9UTWVz",
            "c2FnZRIZCgtyZWdpc3RyeV9pZBgBIAEoCUIE6McxARIRCglkZXZpY2VfaWQY",
            "AiABKAkSEgoKbXF0dF90b3BpYxgDIAEoCRJXCg9pbnZva2VfZnVuY3Rpb24Y",
            "ZSABKAsyPC55YW5kZXguY2xvdWQuc2VydmVybGVzcy50cmlnZ2Vycy52MS5J",
            "bnZva2VGdW5jdGlvbldpdGhSZXRyeUgAQg4KBmFjdGlvbhIEwMExARqMAgoN",
            "T2JqZWN0U3RvcmFnZRJfCgpldmVudF90eXBlGAMgAygOMkMueWFuZGV4LmNs",
            "b3VkLnNlcnZlcmxlc3MudHJpZ2dlcnMudjEuVHJpZ2dlci5PYmplY3RTdG9y",
            "YWdlRXZlbnRUeXBlQgaCyDECPjASEQoJYnVja2V0X2lkGAQgASgJEg4KBnBy",
            "ZWZpeBgGIAEoCRIOCgZzdWZmaXgYByABKAkSVwoPaW52b2tlX2Z1bmN0aW9u",
            "GGUgASgLMjwueWFuZGV4LmNsb3VkLnNlcnZlcmxlc3MudHJpZ2dlcnMudjEu",
            "SW52b2tlRnVuY3Rpb25XaXRoUmV0cnlIAEIOCgZhY3Rpb24SBMDBMQEiygEK",
            "Fk9iamVjdFN0b3JhZ2VFdmVudFR5cGUSKQolT0JKRUNUX1NUT1JBR0VfRVZF",
            "TlRfVFlQRV9VTlNQRUNJRklFRBAAEisKJ09CSkVDVF9TVE9SQUdFX0VWRU5U",
            "X1RZUEVfQ1JFQVRFX09CSkVDVBABEisKJ09CSkVDVF9TVE9SQUdFX0VWRU5U",
            "X1RZUEVfVVBEQVRFX09CSkVDVBACEisKJ09CSkVDVF9TVE9SQUdFX0VWRU5U",
            "X1RZUEVfREVMRVRFX09CSkVDVBADImkKEkludm9rZUZ1bmN0aW9uT25jZRIh",
            "CgtmdW5jdGlvbl9pZBgBIAEoCUIM6McxAYrIMQQ8PTUwEhQKDGZ1bmN0aW9u",
            "X3RhZxgCIAEoCRIaChJzZXJ2aWNlX2FjY291bnRfaWQYAyABKAkiugEKF0lu",
            "dm9rZUZ1bmN0aW9uV2l0aFJldHJ5EiEKC2Z1bmN0aW9uX2lkGAEgASgJQgzo",
            "xzEBisgxBDw9NTASFAoMZnVuY3Rpb25fdGFnGAIgASgJEhoKEnNlcnZpY2Vf",
            "YWNjb3VudF9pZBgDIAEoCRJKCg5yZXRyeV9zZXR0aW5ncxgEIAEoCzIyLnlh",
            "bmRleC5jbG91ZC5zZXJ2ZXJsZXNzLnRyaWdnZXJzLnYxLlJldHJ5U2V0dGlu",
            "Z3MiWAoNQmF0Y2hTZXR0aW5ncxIWCgRzaXplGAEgASgDQgj6xzEEMC0xMBIv",
            "CgZjdXRvZmYYAiABKAsyGS5nb29nbGUucHJvdG9idWYuRHVyYXRpb25CBOjH",
            "MQEiYwoNUmV0cnlTZXR0aW5ncxIfCg5yZXRyeV9hdHRlbXB0cxgBIAEoA0IH",
            "+scxAzEtNRIxCghpbnRlcnZhbBgCIAEoCzIZLmdvb2dsZS5wcm90b2J1Zi5E",
            "dXJhdGlvbkIE6McxASpuCgtUcmlnZ2VyVHlwZRIcChhUUklHR0VSX1RZUEVf",
            "VU5TUEVDSUZJRUQQABIJCgVUSU1FUhACEhEKDU1FU1NBR0VfUVVFVUUQAxIP",
            "CgtJT1RfTUVTU0FHRRAEEhIKDk9CSkVDVF9TVE9SQUdFEAVCewoneWFuZGV4",
            "LmNsb3VkLmFwaS5zZXJ2ZXJsZXNzLnRyaWdnZXJzLnYxWlBnaXRodWIuY29t",
            "L3lhbmRleC1jbG91ZC9nby1nZW5wcm90by95YW5kZXgvY2xvdWQvc2VydmVy",
            "bGVzcy90cmlnZ2Vycy92MTt0cmlnZ2Vyc2IGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(new[] {typeof(global::Yandex.Cloud.Serverless.Triggers.V1.TriggerType), }, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Yandex.Cloud.Serverless.Triggers.V1.Trigger), global::Yandex.Cloud.Serverless.Triggers.V1.Trigger.Parser, new[]{ "Id", "FolderId", "CreatedAt", "Name", "Description", "Labels", "Rule" }, null, new[]{ typeof(global::Yandex.Cloud.Serverless.Triggers.V1.Trigger.Types.ObjectStorageEventType) }, new pbr::GeneratedClrTypeInfo[] { null, new pbr::GeneratedClrTypeInfo(typeof(global::Yandex.Cloud.Serverless.Triggers.V1.Trigger.Types.Rule), global::Yandex.Cloud.Serverless.Triggers.V1.Trigger.Types.Rule.Parser, new[]{ "Timer", "MessageQueue", "IotMessage", "ObjectStorage" }, new[]{ "Rule" }, null, null),
